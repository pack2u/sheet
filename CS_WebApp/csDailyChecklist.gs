 ...
 *      트리거              →  체크 항목        간격
 *   ─────────────────────────────────────────────────
 *      09:30 발주 수집      →  세트분리 1차     10:10
 *      10:30 대리공급 Push  →  푸시 확인 1차    10:40   ← 확인, +10분
 ...
 *   1차는 09:30~10:30 으로 60분이 있고, 2차는 50분, 3차는 40분뿐이다.
 ...
 */
var _CSD_TASKS_ = [
  { id: "T0800", h: 10, m: 10, label: "사방넷 판매현황 및 세트분리 (1차)" },
  { id: "T0920", h: 10, m: 40, label: "대리공급 푸시 확인 (1차)" },
